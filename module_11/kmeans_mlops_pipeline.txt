...
def run_initial_clustering(tfidf_matrix: Any) -> tuple[pd.Series, Any]:
    ...
    if USE_WANDB:
        ...
        artifact = wandb.Artifact("kmeans-model", type="model")
