...
def main() -> None:
    ...
    with get_conn() as conn:
        ...
        """
        print_block(
            "Q1) How many entries are in my database for Fall 2026?",
            run_one(conn, q1, {"term": FALL_2026}),
        )
        ...
        """
        print_block(
            "Q2) What percent of entries are international (not American or Other)?",
            run_one(conn, q2),
        )
        ...
        """
        print_block(
            "Q3) Average GPA / GRE / GRE V / GRE AW (only rows that provide all metrics).",
            run_one(conn, q3),
        )
        ...
        print_block(
            ...
            run_one(conn, q4, {"term": FALL_2026}),
        )
        ...
        print_block(
            ...
            run_one(conn, q5, {"term": FALL_2026}),
        )
        ...
        print_block(
            ...
            run_one(conn, q6, {"term": FALL_2026}),
        )
        ...
        print_block(
            (
                "Q8) Fall 2026 acceptances for (Georgetown/MIT/Stanford/CMU) "
                "PhD CS (downloaded fields)."
            ),
        ...
        print_block(
            ...
            run_one(conn, q9, {"term": FALL_2026}),
        )
        ...
        """
        print_block(
            "Extra Q10) Top 10 programs by acceptance rate (Fall 2026, n>=200).",
            run_one(conn, q10, {"term": FALL_2026}),
        )
        ...
        """
        print_block(
            "Extra Q11) Average GRE Quant by status (Fall 2026, gre>0).",
            run_one(conn, q11, {"term": FALL_2026}),
        )
