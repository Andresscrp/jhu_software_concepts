...
Load applicant_data.json, normalize fields (numbers, blanks, dates), and write
...
def normalize_decision(decision: Any) -> str | None:
    """
    Normalize decision strings into a consistent capitalization (e.g., Accepted, Rejected,
    Interview).
    """
...
def clean_record(record: dict) -> dict:
    """
    Convert one scraped record into a cleaned record with normalized types and parsed
    notification fields.
    """
